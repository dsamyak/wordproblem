...
// Generate questions for a specific world + mode (used by Play/Practice phase).
...
// Every word-problem type carries all the numbers needed inside its own
// questionText, so — unlike a graph-reading question — every type is
// fully answerable from text alone; nothing needs to be excluded here.
