...
const REFLECT_QUESTIONS = [
  { q: "Mia has 6 apples and gets 4 more. What do we do to find the total?", options: [
    { text: "Add: 6 + 4 = 10", correct: true, emoji: "➕" },
    { text: "Subtract: 6 - 4 = 2", correct: false, emoji: "➖" },
    { text: "We don't know", correct: false, emoji: "❓" },
  ]},
  { q: "What does 'altogether' mean in a word problem?", options: [
    { text: "Take away", correct: false, emoji: "❌" },
    { text: "Add the numbers together", correct: true, emoji: "✅" },
    { text: "Multiply", correct: false, emoji: "✖️" },
  ]},
  { q: "In a bar model, what are the two smaller parts?", options: [
    { text: "The two numbers we add", correct: true, emoji: "🧩" },
    { text: "The answer only", correct: false, emoji: "❌" },
    { text: "Nothing important", correct: false, emoji: "❓" },
  ]},
];

const CONFIDENCE_LEVELS = [
  { emoji: '😊', label: "I'm great at word problems!", color: '#4caf50' },
...
export default function ReflectPhase({ stats, onRestart, onGoHome, audioEnabled }) {
  ...
  if (step === 1) {
    return (
      <div className="reflect-phase">
        <div className="reflect-card">
          <h3 className="reflect-card-title">How do you feel about word problems?</h3>
      ...
      <div className="certificate-card">
        ...
        <div className="mascot-container" style={{ marginTop: 16 }}>
          ...
          <div className="speech-bubble">
            {pct >= 80 ? 'Incredible! You are an Addition Master! 🏆' : pct >= 50 ? 'Great effort! Keep practicing! 💪' : 'Good start! Try again to improve! 📚'}
          </div>
        </div>
