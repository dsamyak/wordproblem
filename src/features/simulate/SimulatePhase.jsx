...
import StickerCombineMission from './simulations/StickerCombineMission.jsx';
import BarModelBuilderMission from './simulations/BarModelBuilderMission.jsx';
import NumberLineHopMission from './simulations/NumberLineHopMission.jsx';
import Button from '../../components/Button.jsx';
import { simulationStationNarration } from '../../utils/narration.js';

const STATIONS = [
  { id: 0, icon: '➕', title: 'Sticker Combine Mission',   subtitle: 'Push two groups together and find the total',   Component: StickerCombineMission },
  { id: 1, icon: '📊', title: 'Bar Model Builder Mission', subtitle: 'Build the bar model and find the whole',        Component: BarModelBuilderMission },
  { id: 2, icon: '🐸', title: 'Number Line Hop Mission',   subtitle: 'Count on and find where the frog lands',        Component: NumberLineHopMission },
];
