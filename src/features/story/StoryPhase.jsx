...
const CHAR_DIALOGUE = [
  "How many altogether? 🤔",
  "Push them together — that's adding! ➕",
  "Part + Part = Whole! 📊",
  "Let's solve every word problem! 🎉",
];
...
export default function StoryPhase({ onComplete, playNarration, stop }) {
  ...
  // Each segment in storyNarrations.wordProblems is a single {text, style}
  ...
  useEffect(() => {
    const seg = storyNarrations.wordProblems[currentSlide];
    if (seg) {
